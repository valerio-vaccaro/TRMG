...
| Position | Candle Color | Cryptomancer | Realm |
|----------|-------------|--------------|-------|
| North | White | Alan Turing | Father of the Computable Mysteries |
| NNE | Silver | Claude Shannon | Archon of Information Theory |
| NE | Gold | Whitfield Diffie | Herald of the Public Key |
| ENE | Orange | Martin Hellman | Keeper of the Exponential Veil |
| East | Red | Ron Rivest | First Blade of RSA |
| ESE | Crimson | Adi Shamir | Second Blade of RSA |
| SE | Dark Blue | Leonard Adleman | Third Blade of RSA |
| SSE | Violet | Ralph Merkle | Architect of the Hash Tree |
| South | Green | Bruce Schneier | Sentinel of the Applied Arts |
| SSW | Cyan | Phil Zimmermann | Liberator of the Pretty Good Secret |
| SW | Yellow | Moxie Marlinspike | Whisperer of the Signal Fire |
| WSW | Black | Satoshi Nakamoto | The Unnamed One, Weaver of Chains |

*Light all twelve candles simultaneously, or as close to it as mortal hands allow. Speak aloud the name of each Cryptomancer as their candle ignites. Their accumulated entropy — harvested from a lifetime of secret-making — enters the ritual field and bends probability in your favor.*
